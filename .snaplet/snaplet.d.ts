...
type Enum_public_action_types = 'like' | 'view';
...
interface Table_public_actions {
  id: string;
  episode_id: string;
  user_id: string | null;
  type: Enum_public_action_types;
}
...
interface Table_public_episodes {
  id: string;
  title: string;
  index: number;
  youtube_url: string;
...
interface Schema_public {
  actions: Table_public_actions;
  episodes: Table_public_episodes;
}
interface Schema_realtime {
...
interface Tables_relationships {
  "public.actions": {
    parent: {
       actions_episode_id_episodes_id_fk: "public.episodes";
    };
    children: {
  ...
  "public.episodes": {
    ...
    children: {
       actions_episode_id_episodes_id_fk: "public.actions";
    };
  };
  "auth.identities": {
    parent: {
